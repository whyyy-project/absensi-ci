    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_URL(); ?>wali_kelas">Wali Kelas</a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?= base_URL(); ?>#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true"
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="<?= base_URL(); ?>blank.html">Blank Page</a>
                    </div>
                </div>
            </li>
